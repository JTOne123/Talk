...
namespace Talk.AntiMalice
{
    ...
    public static class AntiMalice
    {
        ...
        /// <returns></returns>
        public static bool GetValue(this HttpContext httpContext, int interval = 30, int nsecond = 15, int usecond = 5)
        {
            var key = "talkantimaliceXX";
        ...
        {
            var isAntiMalice = httpContext.GetValue();
            if (!isAntiMalice)            
